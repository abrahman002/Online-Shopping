...
const ElectronicsGroup = () => {
    return (
        <div className='mt-16'>
             <h1 className='text-3xl font-bold lg:ml-10 mb-2'>Electronics</h1>
            <div className='grid lg:grid-cols-4 grid-cols-2   lg:gap-4 gap-3  lg:p-10  '>
           
                <div className=' bg-base-100  lg:w-72 w-44 mx-auto rounded-md '>
